...
export const CartProducts = () => {
  ...
  return (
    <>
      {cartState.items.map((item: Items) => {
        return (
          <>
            <div
              className="cart-items__wrapper flex justify-center items-start gap-4"
              key={item.id}
            >
              <ProductImage
              ...
              <div className="flex flex-col items-start gap-2">
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    className="cart-items__trash-button flex items-center justify-center h-9 w-24 bg-base-button rounded-lg "
            ...
            <div className="w-full h-[1px] bg-base-button" />
          </>
        );
      })}
    </>
